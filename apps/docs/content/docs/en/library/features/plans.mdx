...
<Callout type="info">
**Plan-First Model:** Plans are the core of Commet's billing. Each plan defines
a pricing template with features, limits, and prices for different billing intervals.
</Callout>
