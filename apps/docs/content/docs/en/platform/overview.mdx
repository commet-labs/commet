...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <div className="border rounded-lg p-4">
    <h3 className="font-semibold mt-0">Products</h3>
    <p className="text-sm text-muted-foreground">Learn how to structure your products and pricing strategies</p>
    <p className="text-sm">[Explore Pricing Types →](./features/products/catalog-overview)</p>
  </div>

  <div className="border rounded-lg p-4">
    <h3 className="font-semibold mt-0">Subscriptions</h3>
    <p className="text-sm text-muted-foreground">Set up customer subscriptions</p>
    <p className="text-sm">[Explore Subscriptions →](./features/subscriptions/subscriptions-overview)</p>
  </div>
  ...
  <div className="border rounded-lg p-4">
    ...
    <p className="text-sm">[Explore Events →](./features/usage-metrics/events)</p>
  </div>

  <div className="border rounded-lg p-4">
    <h3 className="font-semibold mt-0">Seats and licenses</h3>
    <p className="text-sm text-muted-foreground">Charge globally in minutes and get the money in your bank</p>
    <p className="text-sm">[Explore Seats →](./features/seats/seats-overview)</p>
  </div>
</div>
