...
<Cards>
  <Card 
    title="Fixed SaaS" 
    description="Billing integration for a fixed-price SaaS. Perfect for simple subscription plans."
    href="https://github.com/commet-labs/commet/tree/main/examples/fixed-saas"
  />

  <Card 
    title="Team SaaS" 
    description="Seat-based billing with workspace management. Ideal for team collaboration products."
