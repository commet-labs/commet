import { ArrowRight, CreditCard, LayoutList, Shield } from "lucide-react";
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-16 px-4 py-20">
        <section className="flex max-w-lg flex-col items-center gap-6 text-center">
          ...
          <p className="text-muted-foreground">
            Ship a subscription product with fixed pricing. Plans, checkout,
            billing portal, and customer management out of the box.
          </p>
