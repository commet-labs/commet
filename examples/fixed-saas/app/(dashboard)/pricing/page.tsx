      ...
      <div className="mt-20 max-w-2xl mx-auto bg-muted p-8 border border-border flex items-start gap-6">
        ...
        <div>
          ...
          <p className="text-foreground leading-relaxed">
            Choose a plan and subscribe. Your subscription renews automatically
            each billing period. You can upgrade, downgrade, or cancel anytime
            from your <strong>billing portal</strong>.
          </p>
        </div>
      </div>
    </main>
