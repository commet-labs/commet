          ...
          <div className="flex flex-col items-center text-center gap-10">
            ...
            <div className="space-y-6 max-w-4xl">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Build your subscription-based SaaS in record time. Seamlessly
                handle fixed pricing plans, billing portals, and checkout with
                our ready-to-use starter.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <FeatureCard
              ...
              title="Fixed Plans"
              description="Simple, predictable pricing with fixed subscription tiers."
            />
            <FeatureCard
            ...
            <FeatureCard
              ...
              description="Pre-integrated Commet checkout for seamless plan upgrades."
            />
            <FeatureCard
