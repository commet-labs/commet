...
import { ArrowRight, BarChart3, Gauge, ShieldCheck, Zap } from "lucide-react";
          ...
          <div className="flex flex-col items-center text-center gap-10">
            ...
            <div className="space-y-6 max-w-4xl">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Build your usage-based SaaS in record time. Seamlessly handle
                subscriptions, metered billing, and usage tracking with our
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <FeatureCard
              ...
              description="Track and bill based on actual usage with included quotas and overage rates."
            />
            <FeatureCard
              icon={<BarChart3 className="w-6 h-6" />}
              title="Real-time Tracking"
              description="Instant usage reporting with live meters showing consumption vs included amounts."
            />
            <FeatureCard
              icon={<Zap className="w-6 h-6" />}
              title="Instant Checkout"
              description="Pre-integrated Commet checkout for plans with usage-based features."
            />
            <FeatureCard
          ...
          <div className="bg-card p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-border">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold sm:text-4xl mb-6">
                Ready to launch your usage-based SaaS?
              </h2>
              <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">
                Stop building billing from scratch. Use our template to monetize
                your product with metered billing in just 2 minutes.
              </p>
              <Button
                size="lg"
