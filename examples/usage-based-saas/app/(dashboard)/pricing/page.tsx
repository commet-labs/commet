    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-background min-h-screen">
      <div className="max-w-3xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground">
          Scale your product without worrying about complex tiers. Pay for what
          you use, with included quotas in every plan.
        </p>
      </div>
      ...
      <div className="mt-20 max-w-2xl mx-auto bg-muted p-8 border border-border flex items-start gap-6">
        ...
        <div>
          ...
          <p className="text-foreground leading-relaxed">
            Each plan includes a quota of usage for your features (API calls,
            storage, etc.). Use what you need within your included amount at no
            extra cost. If you exceed your quota, overage charges apply based on
            your plan&apos;s rates. Usage resets every billing period.
          </p>
        </div>
      </div>
    </main>
