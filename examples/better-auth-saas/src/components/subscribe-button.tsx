...
export function SubscribeButton({ planCode, prices }: SubscribeButtonProps) {
  ...
  async function handleSubscribe() {
    ...
    try {
      const result = await createSubscriptionAction(planCode, selectedInterval);
      ...
      // If no checkout URL, redirect to pending page
