        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <FeatureCard
              ...
              title="Instant Sync"
              description="Changes to your team are instantly reflected in billing. No complex calculations."
            />
            <FeatureCard
              icon={<Shield className="w-6 h-6" />}
              title="Fair Pricing"
              description="Included seats in your plan, extra seats charged only for overage."
            />
            <FeatureCard
          ...
          <div className="bg-card p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-border">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold sm:text-4xl mb-6">
                Ready to launch your team SaaS?
              </h2>
