import { ArrowRight, Coins, ImageIcon, Mic } from "lucide-react";
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-16 px-4 py-20">
        <section className="flex max-w-lg flex-col items-center gap-6 text-center">
          ...
          <p className="text-muted-foreground">
            Buy credit packs, spend credits on image generation, text
            processing, and voice synthesis. Top up anytime.
          </p>
        ...
        <section className="grid w-full max-w-2xl gap-4 md:grid-cols-3">
          <FeatureCard
            icon={Coins}
            title="Credit packs"
            description="Purchase credit packs with flexible pricing. Top up when you need more."
          />
          <FeatureCard
            icon={ImageIcon}
            title="Usage tracking"
            description="Spend credits on image, text, and voice generation with real-time tracking."
          />
          <FeatureCard
            icon={Mic}
            title="Auth + billing"
