      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-16 px-4 py-20">
        <section className="flex max-w-lg flex-col items-center gap-6 text-center">
          ...
          <p className="text-muted-foreground">
            Ship a usage-based product with metered billing. API calls, storage,
            email sends, and overage billing out of the box.
          </p>
        ...
        <section className="grid w-full max-w-2xl gap-4 md:grid-cols-3">
          <FeatureCard
            icon={BarChart3}
            title="Metered usage"
            description="Track API calls, storage, and email sends with automatic overage billing."
          />
          <FeatureCard
            icon={CreditCard}
            title="Billing portal"
            description="Built-in portal for customers to manage plans and view usage."
          />
          <FeatureCard
            icon={Shield}
            title="Auth + billing"
